...
class TestSparkMacros(unittest.TestCase):
    ...
    def test_macros_create_table_as_partition(self):
        ...
        self.assertEqual(
            sql, "create table my_table partitioned by (partition_1) as select 1"
        )
    ...
    def test_macros_create_table_as_location(self):
        ...
        self.assertEqual(
            sql, "create table my_table location '/mnt/root/my_table' as select 1"
        )
    ...
    def test_macros_create_table_as_comment(self):
        ...
        self.assertEqual(
            sql, "create table my_table comment 'Description Test' as select 1"
        )
